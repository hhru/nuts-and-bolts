 ...
 * </pre>
 * <p>
 * Topic name where application expects to receive retry message is stored in {@link #HEADER_RETRY_RECEIVE_TOPIC}
 * */
public class HeadersMessageMetadataProvider {
  ...
  public static Optional<String> getRetryReceiveTopic(Headers headers) {
    ...
    return Optional
        .ofNullable(headers.lastHeader(HEADER_RETRY_RECEIVE_TOPIC))
        .map(Header::value)
