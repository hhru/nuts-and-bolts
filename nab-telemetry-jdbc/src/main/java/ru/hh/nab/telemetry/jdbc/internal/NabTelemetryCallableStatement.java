...
public class NabTelemetryCallableStatement<S extends CallableStatement> extends NabTelemetryPreparedStatement<S> implements CallableStatement {

  public NabTelemetryCallableStatement(S delegate, NabDbInfo dbInfo, String query, Instrumenter<NabDbRequest, Void> instrumenter) {
