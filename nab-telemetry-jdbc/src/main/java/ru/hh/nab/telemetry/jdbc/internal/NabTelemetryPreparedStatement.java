...
public class NabTelemetryPreparedStatement<S extends PreparedStatement> extends NabTelemetryStatement<S> implements PreparedStatement {

  public NabTelemetryPreparedStatement(S delegate, NabDbInfo nabDbInfo, String query, Instrumenter<NabDbRequest, Void> instrumenter) {
    super(delegate, nabDbInfo, query, instrumenter);
  }
