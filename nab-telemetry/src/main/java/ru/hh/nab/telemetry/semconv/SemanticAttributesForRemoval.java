...
public class SemanticAttributesForRemoval {
  ...
  /**
   * @deprecated TODO HH-278535 this attribute will be removed, use CloudIncubatingAttributes.CLOUD_AVAILABILITY_ZONE instead
   * @see io.opentelemetry.semconv.incubating.CloudIncubatingAttributes#CLOUD_AVAILABILITY_ZONE
   */
  @Deprecated(forRemoval = true)
