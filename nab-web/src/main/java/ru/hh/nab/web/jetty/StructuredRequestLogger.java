...
public class StructuredRequestLogger extends AbstractLifeCycle implements RequestLog {
  ...
  private static final String SERVICE_REQUEST_TIME = "service.request.time";
  private static final String METHOD_TAG_NAME = "method";
  private static final String HTTP_ROUTE_TAG_NAME = "http_route";
  ...
  public void log(Request request, Response response) {
    ...
    final String cacheStatus = ofNullable(request.getAttribute(CACHE_ATTRIBUTE)).map(String::valueOf).orElse(NO_CACHE);
